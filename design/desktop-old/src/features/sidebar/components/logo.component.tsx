const Logo = () => {
    return (
        <div flex flex-direction:column align-items:center gap="0.5rem">
            <svg width={24} height={24} viewBox="0 0 2500 2500" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
            ...
            <span font-size="0.75rem" class="logo-text">
                Nexus Compose
            </span>
        </div>
    )
