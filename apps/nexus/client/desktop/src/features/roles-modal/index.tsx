import { Input, Modal, PermissionInput } from '../../components'
...
const RolesModal = () => {
    return (
        <Modal
            ...
            className="rounded-lg h-fit w-[677px] shadow"
        >
            <div className="flex flex-col gap-4 pt-8">
                <Input name="title" label="Stillingsbetegnelse" />
                <Input name="description" label="Beskrivelse" />
                <PermissionInput />
                <button className="h-12 w-full text-primary bg-primary mt-4">Opret</button>
            </div>
        </Modal>
    )
}
