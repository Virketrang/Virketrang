...
const BusinessSelect = () => {
    ...
    return (
        <div
            style="display: flex; align-items: center; cursor: pointer; font-weight: 500; gap: 1rem; fill: #fff; color: #fff;"
            role="combobox"
        >
            <button>
            ...
            <Show when={!!store()} fallback={null}>
                <span>{(store() as Entity.Company).company_name}</span>
            </Show>
        </div>
    )
}
